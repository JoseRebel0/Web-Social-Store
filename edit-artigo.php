...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  if(!empty($designacao_artigo) && !empty($preco)){

    $sqlquery = "UPDATE artigos SET 
        designacao_artigo = ?,
        descricao = ?,
        WHERE id_artigo = ?";
    ...
    if ($stmt = mysqli_prepare($conn, $sqlquery)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            exit();
                ...
                echo "<script type='text/javascript'> alert('Falha ao editar o artigo.') </script>";
            }
                ...
                <div class="col-12">
                    <form class="card" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                      ...
                      <div class="card-body">
                         ...
                         <input type="hidden" name="id_artigo" id="id_artigo" class="form-control" value="<?php echo trim($_GET['id_artigo'])?>" required>

                          <div class="col-sm-6 col-md-3">
                            <div class="mb-3">
                              <label class="form-label required" for="designacao_artigo">Designação</label>
                              <input type="text" id="designacao_artigo" name="designacao_artigo" value="<?php echo trim($_GET['designacao_artigo']); ?>" class="form-control" placeholder="Nome de designação" required>
                            </div>
                          </div>
                        ...
                        <textarea rows="5" class="form-control" id="descricao" name="descricao" placeholder="Escreve aqui uma descrição sobre este artigo."><?php echo trim($_GET['descricao']); ?></textarea>

                        </div>
                        
                      </div>
                      <div class="card-footer text-end">
                      <a href="lista-artigos.php" class="btn btn-light i">Voltar</a>
