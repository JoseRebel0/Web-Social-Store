...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(!empty($nome) && !empty($nif_fam) && !empty($id_utente) && !empty($relacao)){

        $sqlquery = "INSERT INTO agrefam (nome, id_utente, relacao, nif_fam, notas) 
        VALUES ('$nome', '$id_utente', '$relacao', '$nif_fam', '$notas')";

        if(mysqli_query($conn, $sqlquery)){
            echo "<script type='text/javascript'> alert('Agregado registado com sucesso!') </script>";
        } else {
            echo "<script type='text/javascript'> alert('Falha ao registar agregado: " . mysqli_error($conn) . "') </script>";
        }
    } else {
        echo"<script type='text/javascript'> alert('Falha ao registar agregado. Todos os campos são obrigatórios.') </script>";
    }
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["nome"]))){
        echo "<script type='text/javascript'> alert('Por favor, introduz o nome do agregado!') </script>";
        ...
        $sql = "SELECT id FROM agrefam WHERE nome = ?";
                ...
                <div class="col-12">
                    <form class="card" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">Novo agregado familiar</h4>
                        </div>
                      <div class="card-body">
                         <br>
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                <input type="tel" maxlength="9" minlength="9" class="form-control" placeholder="NIF" id="nif_fam" name="nif_fam" required>
                                </div>
                            </div>
                        ...
                        <textarea rows="5" class="form-control" placeholder="Escreve aqui observações sobre este utente." id ="notas" name="notas"></textarea>
                        </div>
                        </div>
