...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $nif_fam = $_POST['nif_fam'];
    $notas = $_POST['notas'];

    if(!empty($nome) && !empty($nif_fam)){

        $sqlquery = "UPDATE agrefam SET 
            id_utente = ?,
            nome = ?,
            relacao = ?,
            nif_fam = ?,
        ...
        if ($stmt = mysqli_prepare($conn, $sqlquery)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                echo "<script type='text/javascript'>
                        alert('Agregado editado com sucesso!');
                        window.location.href = 'lista-agrefam.php';
                      </script>";
                exit();
            } else {
                echo "<script type='text/javascript'> alert('Falha ao editar o agregado.') </script>";
            }
                ...
                <div class="col-12">
                    <form class="card" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">Editar agregado</h4>
                        </div>
                      <div class="card-body">
                         <br>
                         ...
                         <div class="row row-cards">
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                <div class="mb-3 col-sm-4 col-md-12">
                                    ...
                                    <select name="id_utente" id="id_utente" class="form-select" required>
                                        ...
                                        <option value="<?php echo trim($_GET['id_utente']);?>"><?php echo trim($_GET['nome_utente']);?></option>
                            ...
                            <div class="col-sm-6 col-md-3">
                              <div class="mb-3">
                                <label class="form-label required" for="relacao">Relação</label>
                                <select id="relacao" name="relacao" class="form-select" required>
                                    <option value="<?php echo trim($_GET['relacao']);?>"><?php echo trim($_GET['relacao']);?></option>
                        ...
                        <h4 class="card-title">Informações do membro</h4>

                        <div class="col-sm-6 col-md-3">
                                <div class="mb-3">
                                    <label class="form-label required" for="nome">Nome</label>
                                    <input type="text" class="form-control" value="<?php echo trim($_GET['nome']);?>" placeholder="Nome" id="nome" name="nome" required>
                                </div>
                            </div>
    
                            <div class="col-sm-6 col-md-3">
                                <div class="mb-3">
                                <label class="form-label required" for="nif_fam">NIF</label>
                                <input type="tel" maxlength="9" minlength="9" value="<?php echo trim($_GET['nif_fam']);?>" class="form-control" placeholder="NIF" id="nif_fam" name="nif_fam" required>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 mb-0">
                        <label class="form-label" for="notas">Observações</label>
                        <textarea rows="5" class="form-control" placeholder="Escreve aqui observações sobre este utente." id ="notas" name="notas"><?php echo trim($_GET['notas']);?></textarea>
                        </div>
                        </div>
